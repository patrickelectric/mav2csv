...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "mav2csv.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "mav2csv.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'mav2csv'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'mav2csv':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_434af289a552f51d6663a8f28b115951d657db6b": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);download(($0),"log.json");
            },
        ...
        initialize: function( instance ) {
            ...
            Module.exports.run = function run(file) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.run(Module.STDWEB_PRIVATE.prepare_any_arg(file)));
}
;
            __web_on_grow();
